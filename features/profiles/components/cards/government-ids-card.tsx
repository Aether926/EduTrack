        ...
        <div className="space-y-2">
            <div className="grid grid-cols-2 gap-4">
                {fields.map((f) => (
                    <label
                        key={f.key}
                        className="text-xs font-semibold text-gray-600 dark:text-gray-400 uppercase tracking-wide flex items-center gap-1.5"
                    >
            ...
            <div className="grid grid-cols-2 gap-4">
                {fields.map((f) =>
                    isEditing ? (
                        ...
                        <div
                            key={f.key}
                            className="px-3 py-2 bg-gray-100 dark:bg-gray-900 rounded-md text-sm font-medium"
                        >
