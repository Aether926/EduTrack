...
function EducationForm({ data, isEditing, onInputChange }: {
    ...
    return (
        <div className="space-y-4">
            ...
            <Field label="Bachelor's Degree" value={data.bachelorsDegree} field="bachelorsDegree" isEditing={isEditing} onInputChange={onInputChange} />
        ...
        <>
            ...
            <Card className="flex-col border-0 shadow-lg">
                ...
                <CardContent className="space-y-4">
                    <EducationForm data={data} isEditing={false} onInputChange={onInputChange} />
                </CardContent>
            </Card>
            ...
            <Sheet open={isEditing} onOpenChange={(open) => { if (!open) onCancel?.(); }}>
                ...
                >
                    ...
                    <div className="flex-1 overflow-y-auto px-5 py-5">
                        <EducationForm data={data} isEditing={true} onInputChange={onInputChange} />
                    </div>
