...
import { User, Calendar, ChevronDownIcon, MapPin, Ruler, Weight, Droplets, Phone, Flag, Copy } from "lucide-react";
...
function AddressBlock(props: {
  ...
  const fields = [
    ...
    { key: "Subdivision", label: "Subdivision / Village", half: false, placeholder: "e.g. Greenview Subd." },
    { key: "Barangay", label: "Barangay", half: true, placeholder: "e.g. Bagong Silang" },
    { key: "City", label: "City / Municipality", half: true, placeholder: "e.g. Valencia City" },
    { key: "Province", label: "Province", half: true, placeholder: "e.g. Bukidnon" },
    { key: "ZipCode", label: "ZIP Code", half: true, placeholder: "e.g. 8709" },
  ];
  ...
  return (
    <div className={disabled ? "opacity-50 pointer-events-none" : ""}>
      ...
      <div className="grid grid-cols-2 gap-3">
        {fields.map((field) => (
          <div key={field.key} className={field.half ? "" : "col-span-2"}>
            <InputField
              label={field.label}
  ...
  return (
    <Card className="border-0 shadow-lg w-full xl:max-w-[500px]">
      ...
      <CardContent className="space-y-6 w-full">
        ...
        {/* ── EXISTING: Age, Gender, DOB, Civil Status ── */}
        <div className="space-y-4">
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
