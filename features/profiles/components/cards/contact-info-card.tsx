...
function Field(props: {
  ...
  const { label, value, field, type = "text", icon: Icon, isEditing, onInputChange, rows } = props;
    ...
    <div className="space-y-1.5">
      ...
      {isEditing ? (
        isTextarea ? (
          ...
          <Input type={type} value={value} onChange={(e) => onInputChange(field, e.target.value)} />
        )
      ) : (
