...
import type {
    HRChangeRequestPayload,
    ProfileHRChangeRequest,
} from "@/features/profiles/types/employment-info";

export async function fetchLastHRChangeRequest(
    teacherId: string,
): Promise<ProfileHRChangeRequest | null> {
