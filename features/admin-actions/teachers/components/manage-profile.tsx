                ...
                <div key={row.id} className="relative flex gap-4">
                    ...
                    <div className="flex-1 pb-2">
                        <div className="flex items-center gap-2 flex-wrap mb-1">
                            <span
                                className={`px-2 py-0.5 rounded-full text-xs font-semibold ${TYPE_STYLE[row.appointment_type] ?? "bg-gray-100 text-gray-800"}`}
                            >
...
function TrainingCalendarView({ trainings }: { trainings: TrainingRow[] }) {
    ...
    const selectedTrainings = selectedDay
        ? (trainingDays.get(selectedDay) ?? [])
        : [];
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <DateField
                                        ...
                                        onChange={(v) => {
                                            ...
                                            if (
                                                fields.dateOfLatestAppointment &&
                                                v &&
                                                fields.dateOfLatestAppointment <
                                                    v
                                            ) {
