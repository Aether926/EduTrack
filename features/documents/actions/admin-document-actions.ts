        ...
        await insertActivity([
            {
                ...
                entity_id: docId,
                message: `You approved ${docTypeName}.`,
        ...
        await insertActivity([
            {
                ...
                entity_type: "TeacherDocument",
                entity_id: docId,
                message: `You rejected ${docTypeName}. Reason: ${reason.trim()}`,
                recipient_role: "actor",
                meta: {
                    docId,
                    documentTypeId: doc.document_type_id,
        ...
        await insertActivity([
            {
                ...
                entity_type: "TeacherDocument",
                entity_id: docId,
                message: `You deleted ${docTypeName}.`,
                recipient_role: "actor",
        ...
        await insertActivity([
            {
                ...
                entity_type: "TeacherDocument",
                entity_id: docId,
                message: `You requested resubmission of ${docTypeName}.`,
                recipient_role: "actor",
...
export async function approveDocumentRequest(
    ...
    try {
        ...
        const actorMessage =
            req.type === "DELETE"
                ? `You approved a delete request for ${docTypeName}.`
                : `You approved a resubmit request for ${docTypeName}.`;
...
export async function rejectDocumentRequest(
    ...
    try {
        ...
        const actorMessage =
            req.type === "DELETE"
                ? `You rejected a delete request for ${docTypeName}.`
                : `You rejected a resubmit request for ${docTypeName}.`;
