...
export async function getMyDeletionRequest(): Promise<
    ActionResult<{
        id: string;
        status: string;
        reason: string | null;
...
export async function cancelDeletionRequest(
    ...
    try {
        ...
        if (existing.initiated_by === "ADMIN")
            return {
                ok: false,
                error: "This deletion was initiated by an administrator and cannot be cancelled. Please contact your administrator.",
            };
