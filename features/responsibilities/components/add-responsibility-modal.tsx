                        ...
                        <Input
                            ...
                            placeholder={
                                form.type === "TEACHING_LOAD"
                                    ? "e.g. Math 8 - Section A"
                                    : form.type === "COORDINATOR"
                                      ? "e.g. Science Department Head"
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setDetail("grade")(e.target.value)
                                        }
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <div className="space-y-1.5">
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) =>
                                            setDetail("section")(e.target.value)
                                        }
                                ...
                                <div className="space-y-1.5">
                                    ...
                                    <Input
                                        value={form.details.schedule ?? ""}
                                        onChange={(e) =>
                                            setDetail("schedule")(
                                                e.target.value,
                                            )
                                        }
                                        placeholder="e.g. MWF 7-8AM"
                                    />
                                </div>
                            </div>
                        </div>
