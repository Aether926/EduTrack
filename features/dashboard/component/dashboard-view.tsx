...
export default function DashboardView({
    ...
    return (
        <div className="min-h-screen bg-background">
                    ...
                    <div className="mx-auto w-full max-w-7xl px-4 py-5 md:px-6 md:py-6">
                        <div className="lg:grid lg:grid-cols-[3fr_2fr] lg:gap-4 lg:items-start">
                            ...
                            <div className="space-y-4 min-w-0">
                                ...
                                <ActivityFeed rows={activity as any} role={role} viewerId={viewerId} />
                            </div>
            ...
            {/* Eligibility Sheet (admin mobile) */}
            {isAdmin && (
                <Sheet open={eligibilityOpen} onOpenChange={setEligibilityOpen}>
                    <SheetContent side="bottom" className="h-[85vh] rounded-t-2xl overflow-y-auto p-0">
                        ...
                        <div className="p-4">
                            <SalaryEligibilityOverview data={eligibilityData} count={eligibilityCount} />
                        </div>
                    </SheetContent>
                </Sheet>
            )}
...
const accentMap = {
    blue:    { border: "border-blue-500/30",    iconBg: "bg-blue-500/10 border-blue-500/20",    iconColor: "text-blue-400",    value: "text-blue-400"    },
    ...
    sky:     { border: "border-sky-500/30",     iconBg: "bg-sky-500/10 border-sky-500/20",     iconColor: "text-sky-400",     value: "text-sky-400"     },
    emerald: { border: "border-emerald-500/30", iconBg: "bg-emerald-500/10 border-emerald-500/20", iconColor: "text-emerald-400", value: "text-emerald-400" },
} as const;

function StatCard({
    title, desc, value, icon, accent = "blue",
}: {
