...
type Props = {
  role: string | null;
  viewerId: string;
  stats: { totalProfiles: number; totalTrainings: number; totalSeminars: number };
  events: any[];
  activity: any[];
};

export default function DashboardView({ role, viewerId, stats, events, activity }: Props) {
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-5 md:px-6 md:py-6">
        ...
        <div className="grid gap-4 xl:grid-cols-[1fr_420px] 2xl:grid-cols-[1fr_460px] xl:items-start">
          ...
          <div className="order-1 xl:order-2 xl:sticky xl:top-24 self-start min-w-0">
            <div className="w-full max-w-full xl:max-w-[460px]">
            ...
            <Card className="overflow-hidden">
              ...
              <CardContent className="pt-0">
                <div className="grid gap-3 sm:grid-cols-2">
                  <MiniTile label="Activity items" value={activity.length} />
                  <MiniTile label="Calendar items" value={events.length} />
                </div>
  ...
  return (
    <Card className="overflow-hidden min-w-0">
      <CardHeader className="flex flex-row items-center justify-between space-y-0">
        ...
        <div className="rounded-md border bg-card p-2 shrink-0">{icon}</div>
      </CardHeader>
      <CardContent>
