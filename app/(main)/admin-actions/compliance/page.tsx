    ...
    const [{ data: schools }, { data: policies }, { data: compliance }] =
        await Promise.all([
            ...
            admin
                ...
                .select(
                    "*, teacher:Profile(id, firstName, lastName, email), school:School(id, name)",
                )
    ...
    return (
        <div className="mx-auto w-full max-w-7xl px-4 py-5 md:px-6 md:py-6 space-y-4">
            ...
            <div className="relative rounded-xl border border-border/60 bg-gradient-to-br from-card to-background overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-amber-400/5 pointer-events-none" />
