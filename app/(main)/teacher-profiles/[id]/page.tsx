...
async function getTrainingsForTeacher(teacherId: string, viewerRole: ViewerRole): Promise<TrainingRow[]> {
...
export default async function TeacherPublicProfilePage({
  ...
  return <PublicProfileView profile={fullProfile} from="teacher" viewerRole={viewerRole} trainings={trainings} />;
}
