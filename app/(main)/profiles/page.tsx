...
export default function TeacherProfile() {
    ...
    const [profileData, setProfileData] = useState({
        ...
        bachelorsDegree: "Bachelor of Science in Education - Mathematics",
        postGraduate: "Master of Arts in Education",
    });
        ...
        <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-4 md:p-8">
            <div className="max-w-7xl mx-auto space-y-6">
                    ...
                    <CardContent className="p-6">
                        <div className="flex flex-col md:flex-row items-start md:items-end gap-6 -mt-16">
                            ...
                            <div className="relative">
                                <div className="w-32 h-32 rounded-xl border-4 border-white shadow-xl overflow-hidden bg-gray-200 dark:bg-gray-800">
                                    {preview ? (
                                        <img
                                            src={preview}
                                            alt="Profile"
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    {/* Right Columns - Employment, Government IDs & Education */}
