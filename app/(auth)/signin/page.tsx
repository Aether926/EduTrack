...
const FEATURES = [
    {
        ...
        desc: "Paperless teacher records, always up to date",
    },
    {
        icon: Users,
        label: "Appointment Tracking",
        desc: "Full appointment history at a glance",
    },
    {
        icon: Award,
        label: "Training & Compliance",
        desc: "Monitor L&D attendance and compliance reports",
    },
    {
        icon: ClipboardList,
        label: "Personal Information",
        desc: "Complete personal information in one place",
    },
];
                ...
                <div className="w-full max-w-5xl flex flex-col lg:flex-row items-center gap-14 lg:gap-20">
                    ...
                    <div className="flex-1 w-full text-center lg:text-left">
                        ...
                        <p className="fu fu-3 text-[13.5px] text-[#8a8a9a] leading-relaxed mb-8 max-w-[340px] mx-auto lg:mx-0">
                            EduTrack is the all-in-one faculty management system
                            for Valencia NHS — managing 201 files, appointments,
                            trainings, and compliance in one place.
                        </p>
                        ...
                        <div className="fu fu-4 flex flex-col gap-2.5 max-w-[340px] mx-auto lg:mx-0">
                            {FEATURES.map(({ icon: Icon, label, desc }) => (
                                <div
                                    key={label}
                                    className="feature-pill flex items-center gap-3 px-4 py-3 rounded-xl border border-[#222225] bg-[#141415]/70 backdrop-blur-sm transition-colors"
                                >
                                    ...
                                    <div className="text-left min-w-0">
                                        <p className="text-[12.5px] font-semibold text-[#e8e8e8]">
                                            {label}
                                        </p>
                                        <p className="text-[11px] text-[#555560] truncate">
                                            {desc}
                                        </p>
                                    </div>
                                </div>
                                    ...
                                    <form onSubmit={handleSubmit}>
                                        ...
                                        <div className="mb-5">
                                            ...
                                            <div className="flex items-center justify-between mb-1.5">
                                                <label className="text-[12.5px] font-medium text-[#8a8a9a]">
                                                    Password
                                                </label>
                                                <a
                                                    href="/forgot-password"
                                                    className="text-[12px] text-[#5b8dee] hover:underline transition-colors"
                                                >
                                                    Forgot password?
                                                </a>
                                            </div>
