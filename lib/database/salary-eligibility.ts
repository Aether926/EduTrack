...
export async function getTeacherSalaryEligibility(
    ...
    try {
        ...
        // console.log(
        //     "[salary-eligibility] HR ids:",
        //     hrRows.map((r) => ({ id: r.id, type: typeof r.id })),
        // );
        ...
        // console.log(
        //     "[salary-eligibility] Profiles returned:",
        //     profiles?.map((p) => ({
        //         id: p.id,
        //         type: typeof p.id,
        ...
        for (const r of hrRows) {
            ...
            if (!profileMap.has(key)) {
                // console.warn(
                //     `[salary-eligibility] No Profile match for HR id: "${key}" (raw: ${r.id})`,
                // );
            }
        }
...
export async function markSalaryIncreaseGiven(
    ...
    try {
        ...
        const appointmentDate = new Date(
            hr.dateOfLatestAppointment + "T00:00:00",
        );
